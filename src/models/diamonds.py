...
class Diamonds(inanimateObject):
    def __init__(self):
        ...
        self.skin = pygame.transform.scale(pygame.image.load(
            "src/assets/images/objects/rewards/diamond.png"), (11.54, 12.5))
    ...
    def generateDiamonds(self, screen, count):
        for i in range(count):
            ...
            # ? 15 So it doesn't spawn out or near the edge
            y = random.randint(0, screen.get_height() - 15)
            diamond = pygame.Rect(
                x, y, self.skin.get_width(), self.skin.get_height())
